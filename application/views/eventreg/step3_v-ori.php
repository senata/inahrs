                        ...
                        <div class="participant-tab-content">
                            ...
                            <fieldset>
                                ...
                                <table class="table table-bordered">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input 
														...
														id="participants[<?php echo $key?>][workshops][<?php echo $workshop['id']?>]"
														value="<?php echo $workshop['id']?>|<?php echo $workshop['name'] ?>|<?php echo $workshop['fee_after_boundary']?>"
														<?php if(isset($participants[$key]['registered_to']['workshops'][$workshop['id']]) AND !$is_before_boundary and !is_null($workshop['fee_after_boundary'])) echo "checked"; ?>
														<?php echo ($is_before_boundary) ? 'disabled' : ''; ?>
														<?php echo (is_null($workshop['fee_after_boundary'])) ? 'disabled' : ''; ?>
													> <?php 
													if($workshop['fee_after_boundary'] == null){
														echo 'N/A';
													} else {
                                    ...
                                    <tr>
                                    <td colspan="3" align="center">*Limited for 50 participants</td>
                                    </tr>
                                    </tbody>
                            ...
                            <fieldset>
                                ...
                                <table class="table table-bordered">
                                    <thead>
                                    <tr>
                                        <th id="workshop_title">Satelite Symposium Title</th><th id="workshop_fee"><?php echo $event['label_before_boundary'] ?></th><th id="workshop_fee"><?php echo $event['label_after_boundary'] ?></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php $i=1; ?>
                                    ...
                                    <?php endforeach; ?>
                                    <tr>
                                    <td colspan="2" align="center">Symposium will be held in National Cardiovascular Center Harapan Kita</td>
                                    </tr>
                                    </tbody>
                            </fieldset>
                        </div>
